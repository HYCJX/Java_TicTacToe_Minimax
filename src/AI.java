    ...
    private int evaluate(Symbol symbol, Symbol[][] board) {
        ...
        for (int row = 0; row < Board.rowLength; row++) {
            if (board[row][0] ==  symbol && board[row][1] == symbol && board[row][2] == symbol) {
                return 10;
            } else if (board[row][0] == opponentSymbol && board[row][1] == opponentSymbol && board[row][2] == opponentSymbol){
                return -10;
            }
        }
        //Check columns:
        for (int col = 0; col < Board.columnLength; col++) {
            if (board[0][col] == symbol && board[1][col] == symbol && board[2][col] == symbol) {
                return 10;
            } else if (board[0][col] == opponentSymbol && board[1][col] == opponentSymbol && board[2][col] == opponentSymbol) {
                return -10;
            }
        }
        //Check diagonals:
        if (board[0][0] == symbol && board[1][1] == symbol && board[2][2] == symbol) {
            return 10;
        } else if (board[0][0] == opponentSymbol && board[1][1] == opponentSymbol && board[2][2] == opponentSymbol) {
            return -10;
        } else if (board[0][2] == symbol && board[1][1] == symbol && board[2][0] == symbol) {
            return 10;
        } else if (board[0][2] == opponentSymbol && board[1][1] == opponentSymbol && board[2][0] == opponentSymbol) {
            return -10;
        }
        return 0;
    }
